<template>
  <el-dialog
    ...
    <custom-form ref="customForm" :form-name="formName" :state="state" :form-params="formParams" @closeAndRefreshList="closeAndRefreshList" v-if="formName != ''"/>
  </el-dialog>
</template>
