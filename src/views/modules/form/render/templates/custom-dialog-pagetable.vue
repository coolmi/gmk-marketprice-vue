<template>
  <el-dialog
    ...
    <custom-pagetable ref="customPagetable" :form-name="formName" :state="state" :form-params="formParams" @closeAndRefreshList="closeAndRefreshList" v-if="formName != ''"/>
  </el-dialog>
</template>
  ...
  export default {
    ...
    methods: {
      initData () {
        this.visible = true;
        this.$nextTick(() => {
          this.$refs['customPagetable'].initData();
        })
      },
      showForm() {
        this.visible = true
